CREATE OR REPLACE PACKAGE BODY test_personal_code AS
  ...
  BEGIN
    ut.expect(personal_code.parse_personal_code('37605030299', 'LT').is_valid).to_equal(TRUE);
    ut.expect(personal_code.parse_personal_code('47803111023', 'LT').is_valid).to_equal(TRUE);
  ...
  BEGIN
    ...
    ut.expect(personal_code.parse_personal_code('38002102761', 'EE').gender).to_equal('');
  END;
  ...
  BEGIN
    ...
    ut.expect(personal_code.parse_personal_code('38002102761', 'EE').birth_date).to_equal(TO_DATE(''));
  END;
